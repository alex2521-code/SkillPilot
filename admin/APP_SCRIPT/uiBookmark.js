function uiBookmark() {
    this.pnlBookmarkHTML = `
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<h4 class="breadcrumb-title">Upcoming Courses</h4>
    ...
    this.panelBookmark = ($writer) => {
        let $brk = this;
        $writer.html($brk.pnlBookmarkHTML);
        $brk.onloadPanelBookmark($writer);
