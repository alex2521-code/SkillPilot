function uiProfile() {
    ...
    this.panelUserProfile = ($writer) => {
        let $pf = this;
        $writer.html($pf.pnlUserProfileHTML);
        $pf.onloadPanelUserProfile($writer);

    }

    this.onloadPanelUserProfile = ($writer) => {
        let $pf = this;     
    }

    this.panelTeacherProfile = ($writer) => {
        let $pf = this;
        $writer.html($pf.pnlTeacherProfileHTML);
        $pf.onloadPanelTeacherProfile($writer);

    }

    this.onloadPanelTeacherProfile = ($writer) => {
        let $pf = this;    
